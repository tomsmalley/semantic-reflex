{ mkDerivation, base, bytestring, containers, data-default, dependent-map,
dependent-sum, exception-transformers
...
mkDerivation {
  ...
  src = ./.;
  buildDepends = [
    base bytestring containers data-default
    file-embed ghcjs-dom
